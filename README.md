...
The first two fixture nodes are now bounded Referee-promoted substrates. `TCM-QDEC` and `QLDPC-FORGE` remain gated.
...
- `TCM-QDEC` and `QLDPC-FORGE`: gated.
