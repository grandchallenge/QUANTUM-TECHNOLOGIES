...
The first two qLDPC fixtures and the first three bounded TCM-QDEC experiments are Referee-promoted. `TCM-QDEC-004` and `QLDPC-FORGE` remain gated.
...
- `TCM-QDEC-004` and `QLDPC-FORGE`: gated.
